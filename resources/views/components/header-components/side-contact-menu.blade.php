<div class="menu-toggle-btn-full-shape">
    <div class="menu-toggle-wrap bg-white">
        ...
        <div class="sidebar-body">
            <h5>روابطنا على التواصل الإجتماعي</h5>
            <ul class="sidebar-social">
                <li><a href="#"><i class='bx bxl-facebook'></i><span>facebook.com/mazad</span></a></li>
                <li><a href="#"><i class='bx bxl-twitter'></i><span>twitter.com/mazad/</span></a></li>
        ...
        <div class="sidebar-bottom">
            <p>هل تحتاج لمساعدة? لوسمحت تواصل معنا!</p>
