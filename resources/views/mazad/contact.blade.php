                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-inner">
                                        ...
                                        <input type="text" placeholder="أكتب اسمك">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-inner">
                                        <label>بريد الإلكتروني</label>
                                        <input type="text" placeholder="أكتب بريدك الإلكتروني">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-inner">
                                ...
                                <div class="col-md-12">
                                    <div class="form-inner">
                                        <label>رسالتك</label>
                                        <textarea placeholder="أكتب رسالتك هنا" rows="5"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12 text-end">
                                    <a href="blog-sidebar.html" class="eg-btn btn--fill-primary contact-btn"><span>إرسل الرسالة</span></a>
                                </div>
                            </div>
                        </form>
                    </div>
